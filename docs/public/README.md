...
| [proposals.md](proposals.md) | Envelope / Fragment / adoption gate |
...
5. ../ai.md                     — AI 連携の概念と責務分担
6. examples/                    — schema v8 JSON files（見れば分かる）
7. examples.md                  — narrative・validate-export 読み方
8. examples-non-normative/      — Proposal / Fragment 概念例
9. ai-json-generation-guide.md  — 生成 AI 向け作法（provider 向け）
10. export-schema.md            — フィールドレベル（実装者向け）
```

実装計画・バージョン別の内部仕様は [../specifications/](../specifications/) と [../releases/](../releases/) を参照してください。
