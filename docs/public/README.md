...
| [proposals.md](proposals.md) | AI / provider 提案と将来ロードマップ（概要のみ） |
...
| **Proposal** | schema v8 の外側の候補案（v4.7.2 以降で詳細化） |
...
4. proposals.md       — 将来の Proposal / materialize（概要）
