...
関連: [Travel Ledger Responsibilities](travel-ledger-responsibilities.md) / [Itinerary モデル](itinerary-model.md) / [Expense モデル](expense-model.md) / [Note モデル](note-model.md) / [Export Schema](export-schema.md) / [Reservation Entity Design](reservation-entity-design.md)
...
フィールド・種別・拡張戦略の詳細: **[Reservation Entity Design](reservation-entity-design.md)**（v1.12.0 草案）。
