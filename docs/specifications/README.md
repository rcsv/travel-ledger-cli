...
| [v4.9.2-desktop-read-service-facade.md](v4.9.2-desktop-read-service-facade.md) | Desktop readiness service facade（**v4.9.2 released**） |
| [v4.9.1-trip-optional-metadata-db-implementation.md](v4.9.1-trip-optional-metadata-db-implementation.md) | Trip optional metadata DB implementation（**v4.9.1 released**） |
...
| [v4.8.15-validate-export-currency-warnings.md](v4.8.15-validate-export-currency-warnings.md) | validate-export currency warnings（**v4.8.15 released**） |
| [v4.8.14-currency-fragment-apply-strict-integration.md](v4.8.14-currency-fragment-apply-strict-integration.md) | Currency Fragment apply strict integration（**v4.8.14 released**） |
...
| [v4.8.2-p6p-delete-estimate-confirm.md](v4.8.2-p6p-delete-estimate-confirm.md) | P-6p delete_estimate Proposal Fragment --confirm（**v4.8.2 released**） |
| [v4.8.1-p6p-delete-estimate-dry-run.md](v4.8.1-p6p-delete-estimate-dry-run.md) | P-6p delete_estimate Proposal Fragment dry-run（**v4.8.1 released**） |
| [v4.8.0-p6p-delete-estimate-planning.md](v4.8.0-p6p-delete-estimate-planning.md) | P-6p delete_estimate Proposal Fragment planning（**v4.8.0 released** — documentation-only） |
| [v4.7.48-p6o-update-estimate-confirm.md](v4.7.48-p6o-update-estimate-confirm.md) | P-6o update_estimate --confirm（**v4.7.48 released**） |
