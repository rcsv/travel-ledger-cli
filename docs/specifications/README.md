...
| [reservation-model.md](reservation-model.md) | Reservation モデル（v1.11.0 責務・境界 — 未実装） |
| [reservation-entity-design.md](reservation-entity-design.md) | Reservation Entity Design（v1.12.0 フィールド・種別・拡張 — 未実装） |
