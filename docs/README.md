...
Latest P-6p implementation: [v4.8.1 delete_estimate dry-run](specifications/v4.8.1-p6p-delete-estimate-dry-run.md)（released）

Next P-6p candidate: v4.8.2 delete_estimate --confirm
