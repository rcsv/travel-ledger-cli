...
| [public/proposals.md](public/proposals.md) | Trip Proposal Envelope / Proposal Fragment 概要（[v4.7.2](specifications/v4.7.2-trip-proposal-envelope-concept-spec.md) / [v4.7.3](specifications/v4.7.3-proposal-fragment-concept-spec.md)） |

関連: [v4.7.0 concept review](specifications/v4.7.0-schema-publication-travel-ledger-public-direction-concept-review.md) / [v4.7.1 public docs outline](specifications/v4.7.1-public-readme-schema-docs-outline.md) / [v4.7.2 Trip Proposal Envelope spec](specifications/v4.7.2-trip-proposal-envelope-concept-spec.md) / [v4.7.3 Proposal Fragment spec](specifications/v4.7.3-proposal-fragment-concept-spec.md)
