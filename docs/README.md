...
| [specifications/v4.8.2-p6p-delete-estimate-confirm.md](specifications/v4.8.2-p6p-delete-estimate-confirm.md) | P-6p delete_estimate --confirm（v4.8.2 unreleased draft） |
...
Latest P-6p implementation: [v4.8.2 delete_estimate --confirm](specifications/v4.8.2-p6p-delete-estimate-confirm.md)（released）

Latest P-6p dry-run: [v4.8.1 delete_estimate dry-run](specifications/v4.8.1-p6p-delete-estimate-dry-run.md)（released）

Next P-6p candidate: v4.8.3 delete_estimate post-release review
