...
Latest structural apply review: [v4.7.40 P-6m reorder / move post-release review](specifications/v4.7.40-p6m-itinerary-ordering-move-post-release-review.md)
