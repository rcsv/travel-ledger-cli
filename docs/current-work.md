...
v4.6.41 — Reservation write service Phase R-2+R-3 implementation（リリース準備）
...
**推奨:** v4.6.42 — Phase R-5 adapter cleanup（`print_reservation_detail(&conn, ...)` 削除）
...
R-2+3  v4.6.41  implementation — 本書
