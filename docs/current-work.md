...
v4.7.7 planning — next implementation / schema hardening selection
...
- Cargo version: `4.7.6`
- Latest release: **v4.7.6** — [v4.7.6-notes.md](releases/v4.7.6-notes.md)
...
v4.7.x 外向き入口（concept + authoring + public JSON examples）が v4.7.6 で **揃った**。

## Next action

**v4.7.7 — テーマ未確定。** 候補のみ（確定実装には入らない）:

```text
Proposal implementation planning
public JSON examples review / polish
v4.7.x public schema post-review
migration runner / FK hardening
```

次マイルストーンは相談のうえ決定。v4.7.7 では Proposal / Fragment / materialize の実装には入らない。
