...
**最新 formal release:** [v4.8.6](docs/releases/v4.8.6-notes.md) — Fragment apply JSON `structured_errors[]` exposure（additive、`schema_version: 2` 維持）。

**直近のリリース履歴:**

| Version | 種別 | 概要 |
|---|---|---|
| [v4.8.6](docs/releases/v4.8.6-notes.md) | minor | Fragment apply JSON structured_errors[] exposure |
| [v4.8.5](docs/releases/v4.8.5-notes.md) | minor | Fragment apply internal structured error model + code registry |
...
| [v4.7.43](docs/releases/v4.7.43-notes.md) | minor | P-6n Fragment apply add_estimate --confirm |
...
| [v4.7.32](docs/releases/v4.7.32-notes.md) | minor | Fragment apply delete_itinerary --confirm (P-6j) |
| [v4.7.31](docs/releases/v4.7.31-notes.md) | minor | Fragment apply delete_itinerary dry-run (P-6j) |
...
| [v4.7.26](docs/releases/v4.7.26-notes.md) | minor | Fragment apply add_reservation dry-run (P-6h) |
| [v4.7.25](docs/releases/v4.7.25-notes.md) | minor | Fragment apply add_expense --confirm (P-6g) |
