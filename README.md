...
**最新 formal release:** [v4.8.5](docs/releases/v4.8.5-notes.md) — Fragment apply internal structured error model + code registry（limited wiring、`structured_errors` は internal only）。
