...
| OS | Asset 名（例: v1.0.4） |
|---|---|
| Linux (x86_64) | `caglla-cli-1.0.4-linux-amd64.tar.gz` |
| macOS (Apple Silicon) | `caglla-cli-1.0.4-macos-arm64.tar.gz` |
| Windows (x86_64) | `caglla-cli-1.0.4-windows-amd64.zip` |
