...
run itinerary add 1 --day 1 --time 06:00 --order 1 --location "自宅（example）" \
  "出発、同行者ピックアップ"
...
exp 3 13000 --note "費用区分: 旅費 / 領収書: SAMPLE-RECEIPT-007 / 備考: 予約番号 : EXAMPLE-PARKING-001, 含 予約料 ¥1,000" \
  --expense-date 2026-04-26
...
exp 5 4940 --note "費用区分: 食費 / 領収書: SAMPLE-RECEIPT-025" --expense-date 2026-04-26
exp 5 400 --title "ジュース買い足し" \
  --note "費用区分: 食費 / 領収書: SAMPLE-RECEIPT-020 / 備考: ジャスミン茶、おーいお茶" \
  --expense-date 2026-04-26
...
exp 7 9040 --note "費用区分: 食費 / 領収書: SAMPLE-RECEIPT-003 / 備考: 一人1000円程度" \
  --expense-date 2026-04-26
...
exp 10 1760 --note "費用区分: 旅費 / 領収書: SAMPLE-RECEIPT-012 / 備考: 大人:¥400, 子供: ¥160" \
  --expense-date 2026-04-26
exp 10 3405 --title "御城印、ロルバーンメモ帳" --paid-by-name "Alex" \
  --note "費用区分: 個別：Alex / 領収書: SAMPLE-RECEIPT-002" --expense-date 2026-04-26
exp 10 600 --title "アイスクリーム" --paid-by-name "Alex" \
  --note "費用区分: 個別：Alex / 領収書: SAMPLE-RECEIPT-026" --expense-date 2026-04-26
...
exp 12 15371 --note "費用区分: 食費 / 領収書: SAMPLE-RECEIPT-016" --expense-date 2026-04-26
exp 12 2110 --title "休息時間とか" --paid-by-name "Alex" \
  --note "費用区分: 個別：Alex" --expense-date 2026-04-26
...
exp 15 2110 --title "食材追加 CHIM DON DON" \
  --note "費用区分: 食費 / 領収書: SAMPLE-RECEIPT-004 / 備考: 塩、しょうゆなど" \
  --expense-date 2026-04-26
...
exp 17 1253 --note "費用区分: 食費 / 領収書: SAMPLE-RECEIPT-008 / 備考: ファミリーマート 本部山川もある" \
...
exp 21 3040 --note "費用区分: 旅費 / 領収書: SAMPLE-RECEIPT-015 / 備考: 大人:¥760, 子供: 無料" \
  --expense-date 2026-04-27
exp 21 1000 --title "ツノガエルくじ" --paid-by-name "Alex" \
  --note "費用区分: 個別：Alex / 領収書: SAMPLE-RECEIPT-014" --expense-date 2026-04-27

run itinerary add 1 --day 2 --time 11:00 --order 7 --location "スナックスコール" \
  "昼食"
run itinerary update 22 --category restaurant
exp 22 7600 --note "費用区分: 食費 / 領収書: SAMPLE-RECEIPT-010 / 備考: カレー中心。" \
  --expense-date 2026-04-27
exp 22 600 --title "昼食追加" \
  --note "費用区分: 食費 / 領収書: SAMPLE-RECEIPT-011 / 備考: もちもちドーナツを追加" \
  --expense-date 2026-04-27

run itinerary add 1 --day 2 --order 8 --location "ドリームセンター入口" "周遊バス乗車"
run itinerary update 23 --category transport
exp 23 1500 --note "費用区分: 旅費 / 領収書: SAMPLE-RECEIPT-027 / 備考: 遊覧車１回券 ¥300x5 子供も一律" \
  --expense-date 2026-04-27
...
exp 25 2780 --title "お土産" --paid-by-name "Alex" \
  --note "費用区分: 個別：Alex / 領収書: SAMPLE-RECEIPT-032" --expense-date 2026-04-27

run itinerary add 1 --day 2 --time 14:30 --order 11 --location "沖縄ハナサキマルシェ" \
  "スタバる"
run itinerary update 26 --category restaurant
exp 26 7160 --title "スタバ" --paid-by-name "Alex" \
  --note "費用区分: 個別：Alex / 領収書: SAMPLE-RECEIPT-006 / 備考: 3人ぐらい1000円の飲み物" \
  --expense-date 2026-04-27

run itinerary add 1 --day 2 --time 19:30 --order 12 --location "AMAHAJI" "夕食"
run itinerary update 27 --category restaurant
exp 27 24375 --note "費用区分: 食費 / 領収書: SAMPLE-RECEIPT-019" --expense-date 2026-04-27
...
exp 29 6270 --note "費用区分: 旅費 / 領収書: SAMPLE-RECEIPT-018" --expense-date 2026-04-28
...
exp 33 1000 --title "焼きそば" --paid-by-name "Alex" \
  --note "費用区分: 個別:Alex / 備考: ジュースもろもろ" --expense-date 2026-04-28

run itinerary add 1 --day 3 --order 7 --location "ハイビスカス園" "入園料 ハイビスカス園"
run itinerary update 34 --category activity
exp 34 1300 --note "費用区分: 旅費 / 領収書: SAMPLE-RECEIPT-034 / 備考: 子供:100円、大人:300円" \
...
exp 35 9440 --note "費用区分: 食費 / 領収書: SAMPLE-RECEIPT-013" --expense-date 2026-04-28
...
exp 37 4500 --title "ビーチセット" --paid-by-name "Alex" \
  --note "費用区分: 個別:Alex / 備考: ビーチセット" --expense-date 2026-04-28
...
exp 38 16500 --note "費用区分: 食費 / 領収書: SAMPLE-RECEIPT-001 / 備考: 予約受付なし" \
  --expense-date 2026-04-29

run itinerary add 1 --day 4 --time 07:50 --order 2 "土産屋さん"
run itinerary update 39 --category shopping
exp 39 3700 --title "土産屋さん" --paid-by-name "Jordan" \
  --note "費用区分: 個別：Jordan / 領収書: SAMPLE-RECEIPT-005" --expense-date 2026-04-29
exp 39 8380 --title "土産屋さん" --paid-by-name "Alex" \
  --note "費用区分: 個別:Alex / 領収書: SAMPLE-RECEIPT-021 / 備考: マスコットクジラ、フェイスマスク、ポストカード" \
  --expense-date 2026-04-29
exp 39 3200 --title "SAGAWA BOX" --paid-by-name "Alex" \
  --note "費用区分: 個別:Alex / 領収書: SAMPLE-RECEIPT-001" --expense-date 2026-04-29
exp 39 286 --title "宅配便" --paid-by-name "Alex" \
  --note "費用区分: 個別:Alex / 領収書: SAMPLE-RECEIPT-001" --expense-date 2026-04-29
...
exp 41 6707 --title "お土産" --paid-by-name "Alex" \
  --note "費用区分: 個別:Alex / 領収書: SAMPLE-RECEIPT-032 / 備考: 安納芋の紅芋タルト" \
  --expense-date 2026-04-29
...
exp 43 6760 --note "費用区分: 食費 / 領収書: SAMPLE-RECEIPT-035 / 備考: 一人5000円相当" \
  --expense-date 2026-04-29
...
exp 45 5447 --note "費用区分: 旅費 / 領収書: SAMPLE-RECEIPT-030 / 備考: レギュラー 182円/L、29.93L" \
  --expense-date 2026-04-29
...
exp 48 782 --title "おみやげ" --paid-by-name "Alex" \
  --note "費用区分: 個別:Alex / 領収書: SAMPLE-RECEIPT-017 / 備考: 沖縄そば、さんぴん茶（飲んじゃった）" \
  --expense-date 2026-04-29
...
exp 50 2160 --title "ラングドシャ" --paid-by-name "Alex" \
  --note "費用区分: 個別:Alex / 領収書: SAMPLE-RECEIPT-029 / 備考: 会社のお土産" \
  --expense-date 2026-04-29

run itinerary add 1 --day 4 --time 18:00 --order 14 --location "Royal Host" "夕食"
run itinerary update 51 --category restaurant
exp 51 8052 --note "費用区分: 食費 / 領収書: SAMPLE-RECEIPT-028 / 備考: 祖父母席（example）席" \
  --expense-date 2026-04-29
exp 51 5115 --note "費用区分: 食費 / 領収書: SAMPLE-RECEIPT-031 / 備考: Sam、Riley席" \
  --expense-date 2026-04-29
...
exp 53 3900 --title "ホノルルクッキー" --paid-by-name "Alex" \
  --note "費用区分: 個別:Alex / 領収書: SAMPLE-RECEIPT-024" --expense-date 2026-04-29
exp 53 31800 --title "化粧品" --paid-by-name "Alex" \
  --note "費用区分: 個別:Alex / 領収書: SAMPLE-RECEIPT-022" --expense-date 2026-04-29
exp 53 37500 --title "COACH のバッグ" --paid-by-name "Alex" \
  --note "費用区分: 個別:Alex / 領収書: SAMPLE-RECEIPT-023" --expense-date 2026-04-29
exp 53 445 --title "ジュース買い足し" --paid-by-name "Alex" \
  --note "費用区分: 個別:Alex / 領収書: SAMPLE-RECEIPT-009" --expense-date 2026-04-29
...
rec --day 2 --amount 4860 --currency JPY \
  --memo "美ら海水族館ショップ: ぬいぐRiley、キーホルダー"
